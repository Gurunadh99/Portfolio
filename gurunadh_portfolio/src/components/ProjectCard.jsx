...
export default function ProjectCard({ title, summary, tech = [], year, metrics = [], publication, slug }) {
  ...
  return (
    <article className="p-4 border rounded-lg hover:shadow-lg transition-shadow dark:border-gray-700">
      ...
      <div className="flex flex-wrap gap-2 mb-3">
        {tech.map(t => <span key={t} className="text-xs px-2 py-1 bg-gray-100 dark:bg-gray-800 rounded">{t}</span>)}
      </div>
